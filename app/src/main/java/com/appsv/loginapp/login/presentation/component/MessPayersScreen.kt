...
fun MessPayersScreen(
    ...
    pgScreenState:AdminScreenState
        ...
        val filteredUsers = pgScreenState.usersList.filter { user ->
            ...
            matchesSearch && matchesRole && user.facility==Facility.MESS.name && user.role == Role.USER.name && user.gender==Gender.MALE.name && user.occupation==Occupation.STUDENT.name
        }
